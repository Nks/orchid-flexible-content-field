...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controllers_fields_flexible_content_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controllers/fields/flexible_content_controller */ "./resources/js/controllers/fields/flexible_content_controller.js");
 //We can work with this only when we already have an application

if (typeof window.application !== 'undefined') {
  window.application.register('fields--flexible_content', _controllers_fields_flexible_content_controller__WEBPACK_IMPORTED_MODULE_0__["default"]);
}

/***/ }),

/***/ "./resources/js/controllers/fields/flexible_content_controller.js":
/*!************************************************************************!*\
  !*** ./resources/js/controllers/fields/flexible_content_controller.js ***!
  \************************************************************************/
...
function (_Controller) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "layouts", {});

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "uniqidSeed", '');
  ...
  _createClass(_default, [{
    ...
    value: function fetchLayouts() {
      ...
      this.layoutTargets.forEach(function (layout) {
        var name = layout.dataset.name;

        if (name in _this2.layouts) {
          return;
        }
    ...
    key: "layoutSelect",
    value: function layoutSelect(event) {
      event.preventDefault();
      var selectedLayout = event.target,
          layoutName = event.target.dataset.layout;

      if (!(layoutName in this.layouts)) {
        window.platform.alert("Can't fetch layout ".concat(layoutName), 'danger');
        return false;
      }

      var layout = this.layouts[layoutName];
      this.draw(layoutName, layout, selectedLayout).reorder().checkEmpty();
    }
    /**
     * Draw the layout
     *
    ...
    key: "draw",
    value: function draw(name, layout, original) {
      var html = layout.element.innerHTML,
          index = original.dataset.index,
          key = this.getKey();
      html = html.replace(new RegExp(index, 'g'), key).replace(new RegExp('data-fc_key=""'), 'data-fc_key="' + key + '"');
    ...
    value: function initDragDrop() {
      var self = this;
      dragula__WEBPACK_IMPORTED_MODULE_1___default()([this.blocksTarget], {
    ...
    value: function getKey() {
      var possibleKey = this.uniqid('fc_');
    ...
    value: function reorder() {
      ...
      this.blocksTarget.querySelectorAll('.layout[data-fc_key]').forEach(function (block) {
        var newKey = _this3.getKey(),
            oldKey = block.dataset.fc_key;

        block.dataset.fc_key = newKey;
        var inputs = block.querySelectorAll('[name*="' + oldKey + '"]');
      ...
      this.layoutIndexTargets.forEach(function (index, key) {
    ...
    key: "uniqid",
    value: function uniqid(prefix, moreEntropy) {
...
_defineProperty(_default, "targets", ["layout", "blocks", "content", "layoutIndex"]);
...
__webpack_require__(/*! /Users/nks/Projects/laravel/tailgateguys.test/packages/nakukryskin/orchid-flexible-content-field/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/nks/Projects/laravel/tailgateguys.test/packages/nakukryskin/orchid-flexible-content-field/resources/sass/app.scss */"./resources/sass/app.scss");


/***/ })

/******/ });
//# sourceMappingURL=flexible_content.js.map