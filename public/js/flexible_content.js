...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function layoutSelect(event) {
      ...
      var layoutName = event.target.dataset.layout;

      if (!(layoutName in this.layouts)) {
        window.platform.alert("Can't fetch layout ".concat(layoutName), 'error');
        return false;
      }
    ...
    key: "draw",
    value: function draw(name, layout) {
    ...
    value: function fetchLayouts() {
      ...
      this.layoutTargets.forEach(function (layout, index) {
    ...
    value: function initDragDrop() {
      var self = this;
      dragula__WEBPACK_IMPORTED_MODULE_1___default()([this.repeaterContainerTarget], {
...
_defineProperty(_default, "targets", ["layout", "blocks", "content"]);
